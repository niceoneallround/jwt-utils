...
jwtUtils.sign = function sign(crypto, graph, props) {
  ...
  assert(crypto.issuer, util.format('crypto.issuer is missing:%j', crypto));
  assert(crypto.jwt, util.format('crypto.jwt props missing:%j', crypto));
  assert(crypto.jwt.type, util.format('crypto.jwt.type props missing:%j', crypto));
  assert(crypto.jwt.secret, util.format('crypto.jwt.secret props missing:%j', crypto));
