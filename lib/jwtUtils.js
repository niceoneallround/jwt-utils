...
const PN_JWT_TYPE = {
  ack: 'https://pn.schema.webshield.io/type#ack',
...
const ACK_ID_CLAIM = 'https://pn.schema.webshield.io/prop#ack_id';
...
//
// Used in conjunction with an error Http Status
// Create a JWT that contains
