...
//   issuer: comes from the jwtOptions
//
jwtUtils.signSubjectQueryResult = function signSubjectQueryResult(queryResult, subjects, privacyPipeId, jwtOptions, props) {
  'use strict';
  ...
  assert(subjects, 'signSubjectQueryResult subjects param missing');
  ...
  payload[SUBJECT_CLAIM] = subjects;
  payload[PRIVACY_PIPE_CLAIM] = privacyPipeId;
