...
describe('JWT learn Tests', function () {
  'use strict';

  describe('1. JWT Tests learning how to break up signature and re-form', function () {

    it('1.1 the learn test - result could not reform which is ok as not using', function () {
